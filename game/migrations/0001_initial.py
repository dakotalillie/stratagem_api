# Generated by Django 2.0.4 on 2018-06-19 16:00
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_type', models.CharField(choices=[('hold', 'hold'), ('move', 'move'), ('support', 'support'), ('convoy', 'convoy'), ('create', 'create'), ('delete', 'delete')], max_length=7)),
                ('coast', models.CharField(blank=True, choices=[('NC', 'NC'), ('EC', 'EC'), ('SC', 'SC')], max_length=2)),
        ...
        migrations.AddField(
            model_name='order',
            name='country',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='orders', to='game.Country'),
        ),
        migrations.AddField(
            model_name='order',
            name='destination',
        ...
        migrations.AddField(
            model_name='order',
            name='unit',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='orders', to='game.Unit'),
        ),
        migrations.AddField(
            model_name='country',
            name='game',
