# Generated by Django 2.0.4 on 2018-04-09 20:57
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('season', models.CharField(choices=[('spring', 'spring'), ('fall', 'fall')], max_length=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('unit_type', models.CharField(choices=[('army', 'army'), ('fleet', 'fleet')], max_length=1)),
                ('coast', models.CharField(blank=True, choices=[('NC', 'north'), ('EC', 'east'), ('SC', 'south')], max_length=2)),
